...
// 함수 선언 → 화살표 함수 (표현)식 - 아주 중요!!!!

// 화살표 함수는 arguments 사용 못함
// 인자에 rest parameter를 사용 - 진짜 배열로 만들어줌!
// (줄여서 rest라고 사용, 다른 단어를 인자에 넣어도 됨)

let calcAllMoney = (...rest) => {
  // console.log(rest); // [10000, 30000, 50000] 배열이 됨
...
// Arrow function은 this를 바인딩 하지 않습니다. - 바로 위 상위 요소에서 this를 찾음
const b = () => {
  console.log(this);
};
