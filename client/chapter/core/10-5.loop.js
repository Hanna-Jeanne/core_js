...
// prototype 안에 symbol(symbol.iterator)이 있어야 순환 가능!
...
// 유사 배열 (배열과 비슷하지만 배열이 아닌 것 - 많이 존재함)
const arrayLike = {
  0: 'body',
  1: 'head',
  2: 'div',
...
// 객체는 for ... of로 순환할 수 없음 - 에러
// string 문자열은 iterable 함
...
//   console.log(value.id); // id만 조회 가능
// }
...
for (const value of languages) {
  // console.table(value); // table로 보여줌 -참고
